...
<main class="restaurant-page">
	...
	<section class="hero-mobile">
		...
		<div class="actions-mobile">
			...
			<div class="actions-btn-right">
				<button class="btn-share" aria-label="Partager ce restaurant">
				...
				<button class="btn-favorite" aria-label="Ajouter ce restaurant en favori">
					<div class="btn-mobile-hero">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
	...
	<section id="restaurant-layout">
		...
		<section class="restaurant-infos-desktop">
			<div class="infos-text-desktop">
				<p class="restaurant-type">Cuisine terroir raffinée</p>
				<p class="restaurant-location">Paris, 8e</p>
			</div>
			<div class="notes-avis-desktop">
				<div class="restaurant-rating">
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none" class="star-icon">
						<path d="M10.5 0L12.8574 7.25532H20.4861L14.3143 11.7394L16.6717 18.9947L10.5 14.5106L4.32825 18.9947L6.68565 11.7394L0.513906 7.25532H8.1426L10.5 0Z" fill="black" />
					</svg>
		...
		<section class="presentation">
			...
			<div class="read-more-presentation">
		...
		<section class="section-map">
			...
			<div class="map-container">
				<picture>
					<source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/maps-restaurant.webp" type="image/webp">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/maps-restaurant.jpg" alt="Carte du quartier du restaurant">
				</picture>
				<div class="marker">
		...
		<section class="booking">
			...
			<button class="btn-book open-reservation-modal">Réserver</button>
		</section>
...
<div class="modal-reservation hidden" role="dialog" aria-modal="true" aria-labelledby="modal-title-reservation">
