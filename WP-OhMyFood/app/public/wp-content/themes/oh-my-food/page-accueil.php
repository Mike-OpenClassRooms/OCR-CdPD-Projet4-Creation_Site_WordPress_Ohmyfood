...
<div class="entry-content">
	<section class="home-recherche-mobile" role="search" aria-label="Recherche de restaurants">
		...
		<div class="home-search-wrapper">
			<div class="home-search-bar">
				...
				<input type="text" placeholder="Rechercher un restaurant" aria-label="Rechercher un restaurant par nom ou type de cuisine" />
				<div class="home-filter-icon" role="button" tabindex="0" aria-label="Ouvrir les filtres de recherche" aria-pressed="false">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="none">
	...
	<section class="home-section-restaurants" role="region" aria-labelledby="restaurants-title">
		<!-- Cards restaurants -->
		<!-- Card 1 -->
		<a href="<?php echo get_permalink(get_page_by_path('restaurant')); ?>" class="home-card-link" aria-label="Voir la fiche du restaurant L’Ambroisie d’Or">
		...
		<div class="home-card-restaurant">
			<div class="home-image-wrapper">
				<picture>
					<source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/sakura-prestige.webp" type="image/webp">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/sakura-prestige.jpg" alt="Sakura Prestige" loading="lazy">
				</picture>
				<div class="home-badge">Coup de cœur</div>
				<div class="home-heart-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
			...
			<div class="home-info">
				<div class="home-details">
					<p class="restaurant-name">Sakura Prestige</p>
					<p class="type-cuisine">Gastronomie japonaise contemporaine</p>
					<p class="location-restaurant">Paris, 16e</p>
				</div>
				<div class="home-rating">
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
						<path d="M10.5 0.700012L12.8574 7.95533H20.4861L14.3143 12.4394L16.6717 19.6947L10.5 15.2107L4.32825 19.6947L6.68565 12.4394L0.513906 7.95533H8.1426L10.5 0.700012Z" fill="black" />
		...
		<div class="home-card-restaurant">
			<div class="home-image-wrapper">
				<picture>
					<source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/osteria-bella-note.webp" type="image/webp">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/osteria-bella-note.jpg" alt="Osteria Bella Notte" loading="lazy">
				</picture>
				<div class="home-badge">Coup de cœur</div>
				<div class="home-heart-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
			...
			<div class="home-info">
				<div class="home-details">
					<p class="restaurant-name">Osteria Bella Notte</p>
					<p class="type-cuisine">Spécialités italiennes revisitées</p>
					<p class="location-restaurant">Versailles (78)</p>
				</div>
				<div class="home-rating">
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
						<path d="M10.5 0.700012L12.8574 7.95533H20.4861L14.3143 12.4394L16.6717 19.6947L10.5 15.2107L4.32825 19.6947L6.68565 12.4394L0.513906 7.95533H8.1426L10.5 0.700012Z" fill="black" />
		...
		<div class="home-card-restaurant">
			<div class="home-image-wrapper">
				<picture>
					<source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/atelier-viande-vin.webp" type="image/webp">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/atelier-viande-vin.jpg" alt="Atelier Viande & Vin" loading="lazy">
				</picture>
				<div class="home-heart-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
						<path fill-rule="evenodd" clip-rule="evenodd" d="M11.9932 5.13581C9.9938 2.7984 6.65975 2.16964 4.15469 4.31001C1.64964 6.45038 1.29697 10.029 3.2642 12.5604C4.89982 14.6651 9.84977 19.1041 11.4721 20.5408C11.6536 20.7016 11.7444 20.7819 11.8502 20.8135C11.9426 20.8411 12.0437 20.8411 12.1361 20.8135C12.2419 20.7819 12.3327 20.7016 12.5142 20.5408C14.1365 19.1041 19.0865 14.6651 20.7221 12.5604C22.6893 10.029 22.3797 6.42787 19.8316 4.31001C17.2835 2.19216 13.9925 2.7984 11.9932 5.13581Z" fill="#222222" fill-opacity="0.6" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
			...
			<div class="home-info">
				<div class="home-details">
					<p class="restaurant-name">Atelier Viande & Vin</p>
					<p class="type-cuisine">Grill haut de gamme & accords mets-vins</p>
					<p class="location-restaurant">Neuilly-sur-Seine (92)</p>
				</div>
				<div class="home-rating">
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
						<path d="M10.5 0.700012L12.8574 7.95533H20.4861L14.3143 12.4394L16.6717 19.6947L10.5 15.2107L4.32825 19.6947L6.68565 12.4394L0.513906 7.95533H8.1426L10.5 0.700012Z" fill="black" />
		...
		<div class="home-card-restaurant">
			<div class="home-image-wrapper">
				<picture>
					<source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/la-table-vegetale.webp" type="image/webp">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/la-table-vegetale.png" alt="La Table Végétale" loading="lazy">
				</picture>
				<div class="home-heart-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
						<path fill-rule="evenodd" clip-rule="evenodd" d="M11.9932 5.13581C9.9938 2.7984 6.65975 2.16964 4.15469 4.31001C1.64964 6.45038 1.29697 10.029 3.2642 12.5604C4.89982 14.6651 9.84977 19.1041 11.4721 20.5408C11.6536 20.7016 11.7444 20.7819 11.8502 20.8135C11.9426 20.8411 12.0437 20.8411 12.1361 20.8135C12.2419 20.7819 12.3327 20.7016 12.5142 20.5408C14.1365 19.1041 19.0865 14.6651 20.7221 12.5604C22.6893 10.029 22.3797 6.42787 19.8316 4.31001C17.2835 2.19216 13.9925 2.7984 11.9932 5.13581Z" fill="#222222" fill-opacity="0.6" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
			...
			<div class="home-info">
				<div class="home-details">
					<p class="restaurant-name">La Table Végétale</p>
					<p class="type-cuisine">Cuisine végétarienne gastronomique</p>
					<p class="location-restaurant">Paris, 3e</p>
				</div>
				<div class="home-rating">
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
						<path d="M10.5 0.700012L12.8574 7.95533H20.4861L14.3143 12.4394L16.6717 19.6947L10.5 15.2107L4.32825 19.6947L6.68565 12.4394L0.513906 7.95533H8.1426L10.5 0.700012Z" fill="black" />
		...
		<div class="home-card-restaurant">
			<div class="home-image-wrapper">
				<picture>
					<source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/l-ocean.webp" type="image/webp">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/restaurants/l-ocean.jpg" alt="L’Océan" loading="lazy">
				</picture>
				<div class="home-heart-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
						<path fill-rule="evenodd" clip-rule="evenodd" d="M11.9932 5.13581C9.9938 2.7984 6.65975 2.16964 4.15469 4.31001C1.64964 6.45038 1.29697 10.029 3.2642 12.5604C4.89982 14.6651 9.84977 19.1041 11.4721 20.5408C11.6536 20.7016 11.7444 20.7819 11.8502 20.8135C11.9426 20.8411 12.0437 20.8411 12.1361 20.8135C12.2419 20.7819 12.3327 20.7016 12.5142 20.5408C14.1365 19.1041 19.0865 14.6651 20.7221 12.5604C22.6893 10.029 22.3797 6.42787 19.8316 4.31001C17.2835 2.19216 13.9925 2.7984 11.9932 5.13581Z" fill="#222222" fill-opacity="0.6" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
			...
			<div class="home-info">
				<div class="home-details">
					<p class="restaurant-name">L’Océan</p>
					<p class="type-cuisine">Poissons & fruits de mer d’exception</p>
					<p class="location-restaurant">Saint-Germain-en-Laye (78)</p>
				</div>
				<div class="home-rating">
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
						<path d="M10.5 0.700012L12.8574 7.95533H20.4861L14.3143 12.4394L16.6717 19.6947L10.5 15.2107L4.32825 19.6947L6.68565 12.4394L0.513906 7.95533H8.1426L10.5 0.700012Z" fill="black" />
	...
	<div class="home-cta-carte">
		<button class="home-button-map" aria-label="Afficher la carte des restaurants">
			Carte
